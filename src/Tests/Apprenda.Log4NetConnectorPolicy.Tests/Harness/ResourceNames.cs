...
namespace Apprenda.Log4NetConnectorPolicy.Tests
{
    ...
    {
        public const string AspWithConfigSectionExplicit = "Resources.aspnet-config-sectionhandler.zip";
        public const string AspWithStandaloneExplicit = "Resources.aspnet-log4net-explicit-standalone.zip";
        ...
        public const string WcfWithConfigSectionExplicitUpdated = "Resources.wcf-appconfig-explicit-l4n208.zip";
        ...
        public const string AspWithoutLog4Net = "Resources.aspnet-nologging.zip";
    }
}
